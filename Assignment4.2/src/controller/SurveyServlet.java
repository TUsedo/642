...
public class SurveyServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList <String> sid = dao.getStudentID();
		displayAcknoledgement(db,request,response,sb, sid);
	}
	...
	private void displayAcknoledgement(DataBean databean, HttpServletRequest request, HttpServletResponse response,StudentBean studentbean, ArrayList<String> sid) throws ServletException, IOException {
		String address;
		...
		RequestDispatcher dispatch = request.getRequestDispatcher(address);
