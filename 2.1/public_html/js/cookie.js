...
function greetingMessage(name) {
	if (name != "null" && name != "") {
		...
		document.getElementById("welcome_msg").innerHTML = welcome + unescape(name) + " Welcome to our Website for Assignment #3. If you are not " + unescape(name) + " <a onclick = \"wrongPerson()\"> Click Here</a>";
	}
	else
		setCookie();	
}
