...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <tr><td></td></tr>
            <tr>
                <td width ="400 px"><label>Will You Recommend the School to your Friends</label></td>
                <td><input type ="text" readonly value ="${sb.recommendation}"size ="40"></input></td>
            </tr>
            <tr><td></td></tr>
            <tr><td></td></tr>
            <tr>
                <td width ="400 px"><label>Data</label></td>
                <td><input type ="text" readonly value ="${sb.data}"size ="40"></input></td>
            </tr>
            <tr><td></td></tr>
            <tr><td></td></tr>             
        </table>
